...
public class CardControllerTest {
  ...
  void get_cards_should_return_empty_list_if_no_cards() throws Exception {
    ...
    List<Card> response = objectMapper.readValue(contentAsString, new TypeReference<>() {
    });
  ...
  void get_cards_should_return_list_with_one_card_from_repo() throws Exception {
    String cardText = "hello world!";
    given(cardService.getCards()).willReturn(List.of(new Card(cardText, 1)));
